...
INSERT INTO user (id, username, password, enabled, name, surname, born_date, street, number, city, post_code) VALUES (4, 'blodie', '$2a$10$yhHbOCRiYk2c1dMC4GVTdu7cv/E8E0v3f9oNJjFuqk9Eq90lIpAuy', TRUE, 'Zosia', 'Abacka', '1977-12-30', 'Lotnicza', '2b', 'Katowice', '44-321');
...
INSERT INTO user (id, username, password, enabled, name, surname, born_date, street, number, city, post_code) VALUES (6, 'admin', 'sz4pahrWJlnExsAt23UenePab3jNmLZpqXcXQRUbRMtR3KUcRhhiG', TRUE, 'Jacek', 'Placek', '1986-08-12', 'Kasztanowa', '7', 'Wrocław', '54-123');
